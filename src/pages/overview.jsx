    ...
    <Container>
      <Grid>
        <OverviewLandingImage>
          <GatsbyImage
            image={data.faithStory.childImageSharp.gatsbyImageData}
          />
        </OverviewLandingImage>
        <OverviewLanding>
        ...
        <TraversalSection>
          ...
          <GatsbyImage image={data.runners.childImageSharp.gatsbyImageData} />
        ...
        <AdditionsSection>
          ...
          <div className="MagRope">
            ...
            <GatsbyImage
              image={data.faithGrapple.childImageSharp.gatsbyImageData}
            />
          ...
          <div className="Focus">
            ...
            <GatsbyImage
              image={data.faithCombatBlue.childImageSharp.gatsbyImageData}
            />
